...
const messages = [
  {
    id: 1,
    sender: "Ojo Oyewole (CYS/HND/3280)",
    subject: "My assignment on application security!",
  ...
  {
    id: 2,
    sender: "Musiliu Ishola (CYS/HND/3250)",
    subject: "Our week 2 group assignment!",
    snippet: "A small river named Duden flows by their supplies necessary regalia.",
    date: "20 Mar 2018",
    content: "Lorem ipsum dolor sit amet, consectetur adipiscing elit...",
    attachment: "My-Photo.jpgAustralia-trip.ppt",
  ...
  },
  {
    ...
    subject: "Getting started on how to run innovation and premier of group 10 project!",
    snippet: "A small river named Duden flows by their supplies necessary regalia.",
    date: "20 Mar 2018",
    content: "Lorem ipsum dolor sit amet, consectetur adipiscing elit...",
    attachment: "My-Photo.jpgAustralia-trip.ppt",
...
const InboxPage = () => {
  ...
  const navigateToCompose = (id) => {
    router.push(`/student/inbox/compose/${params.id}`); // Navigate to dynamic page
  };
