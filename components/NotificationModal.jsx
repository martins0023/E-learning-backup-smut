...
const NotificationModal = () => {
  ...
  const viewInbox = () => {
    router.push(`/lecturer/inbox/${params.id}`)
  }
        ...
        <div className="absolute top-14 right-4 bg-white w-100 max-w-md rounded-lg shadow-lg p-4 z-50">
          ...
          <div className="mt-4 max-h-60 overflow-y-auto space-y-4">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">
                  <span className="font-bold">Ojo Oyewole</span> submitted an assignment: <span>CYS 421 Quiz...</span>
                </p>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">
                  <span className="font-bold">Miracle Oladapo</span> submitted a
                  quiz: <span>quiz has been...</span>
                </p>
                <p className="text-xs text-gray-500">30 mins ago</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">
                  <span className="font-bold">Ayomikun Ola</span> submitted a
                  group project: <span>the group project has been updated...</span>
                </p>
                <p className="text-xs text-gray-500">30 mins ago</p>
              </div>
            </div>
